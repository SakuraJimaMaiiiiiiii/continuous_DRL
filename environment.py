...
class Environment(gym.Env):
    def __init__(self, render_mode=False, max_steps=200):
        super(Environment, self).__init__()
        self.grid_size = 30  # 地图尺寸
        ...
        self.sensor_range = 10.0  # 传感器的探测范围 每个传感器的最大检测范围
    ...
    def step(self, action):
        ...
        # 总奖励
        reward = 10 * distance_reward + 0.5 * direction_reward  # <1
