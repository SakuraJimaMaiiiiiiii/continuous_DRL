class TD3:
    ...
    def learn(self, batch_size=100):
        ...
        with torch.no_grad():
            ...
            # 目标 Q 值
            target_value1 = self.critic_target_net1(next_state, next_action)
            target_value2 = self.critic_target_net2(next_state, next_action)
            target_value = reward + (1 - done) * self.gamma * torch.min(target_value1, target_value2)
